                            ...
                            def test_keys_are_deterministic(self):
                                ...
                                def test_different_token_different_keys(self):
                                    ...
                                    def test_backward_compat_info_param_default(self):
                                        ...
                                        legacy_explicit = derive_key(
                                            TOKEN_ID, WALLET_SIG, info=_INFO_LEGACY
                                        )
                                            ...
                                            def test_clean_markdown_passes(self):
                                                ...
                                                def test_large_content_passes(self):
                                                    ...
                                                    def test_with_correct_hash_passes(self):
                                                        ...
                                                        verify_content(
                                                            content, "test", expected_hash=expected
                                                        )

                                                        def test_without_hash_param_skips_hash_check(
                                                            self,
                                                        ):
                                                            content = b"# Valid\n\nContent here.\n"
                                                            verify_content(
                                                                content, "test", expected_hash=None
                                                            )  # no hash check
                                                                                                                ...
                                                                                                                def test_case_insensitive(
                                                                                                                    ...
                                                                                                                    def test_midtext_injection(
                                                                                                                        ...
                                                                                                                        def test_label_appears_in_error(
                                                                                                                            ...
                                                                                                                            def test_clean_content_with_word_ignore_passes(
                                                                                                                                self,
                                                                                                                            ):
                                                                                                                                ...
                                                                                                                                def test_injection_patterns_list_not_empty(
                                                                                                                                    self,
                                                                                                                                ):
                                                                                                                                    assert (
                                                                                                                                        len(
                                                                                                                                    ...
                                                                                                                                    class TestLocalIndexCache:
                                                                                                                                        ...
                                                                                                                                        def test_section_hashes_survive_roundtrip(
                                                                                                                                            self,
                                                                                                                                            tmp_path,
                                                                                                                                            monkeypatch,
                                                                                                                                        ):
