            ...
            def test_signup_immediate_session(self):
                ...
                def test_signup_supabase_error_returns_400(self):
                    ...
                    def test_signup_null_user_returns_400(self):
                        ...
                        with patch("api.routes.auth._supabase_service", return_value=mock_sb):
                            res = client.post(
                                "/auth/signup", json={"email": "test@example.com", "password": "pw"}
                            )
                            assert res.status_code == 400
                        ...
                        def test_signup_missing_fields_returns_422(self):
                            ...
                            class TestLogin:
                                def test_login_success(self):
                                    ...
                                    with patch(
                                        "api.routes.auth._supabase_anon",
                                        return_value=_make_mock_supabase(),
                                    ):
                                        res = client.post(
                                            "/auth/login",
                                            json={
                                    ...
                                    def test_login_wrong_credentials_returns_401(self):
                                        ...
                                        with patch(
                                            "api.routes.auth._supabase_anon", return_value=mock_sb
                                        ):
                                            res = client.post(
                                                "/auth/login",
                                                json={
                                        ...
                                        def test_login_no_session_returns_401(self):
                                            ...
                                            mock_sb.auth.sign_in_with_password.return_value.session = (
                                                None
                                            )
                                                ...
                                                class TestAuthStatus:
                                                    def _make_token(
                                                        ...
                                                        def test_status_valid_token(self):
                                                            ...
                                                            with patch(
                                                                "api.routes.auth._supabase_service",
                                                                return_value=mock_sb,
                                                            ):
                                                                res = client.get(
                                                                    "/auth/status",
                                                            ...
                                                            def test_status_no_token_returns_401(
                                                                self,
                                                            ):
                                                                res = client.get("/auth/status")
                                                                assert res.status_code == 401

                                                                def test_status_expired_token_returns_401(
                                                                    self,
                                                                ):
                                                                    import jwt
                                                                    import time
                                                                    ...
                                                                    def test_status_no_subscription_returns_inactive(
                                                                        self,
                                                                    ):
