                                                ...
                                                class TestExtractDescription:
                                                    def test_returns_first_non_heading_line(self):
                                                        ...
                                                        def test_skips_heading_lines(self):
                                                            ...
                                                            assert (
                                                                result == "Actual description here."
                                                            )
                                                            ...
                                                            def test_skips_horizontal_rules(self):
                                                                ...
                                                                def test_truncates_to_120_chars(
                                                                    self,
                                                                ):
                                                                    long_line = "A" * 200
                                                                    content = (
                                                                                                ...
                                                                                                def test_no_match_returns_empty(
                                                                                                    ...
                                                                                                    def test_threshold_filters_low_scores(
                                                                                                        ...
                                                                                                        def test_empty_query_returns_empty(
                                                                                                            ...
                                                                                                            def test_numeric_only_query_returns_empty(
                                                                                                                self,
                                                                                                            ):
                                                                                                                results = query_packages(
                                                                                                                    "123 456",
                                                                                                                ...
                                                                                                                def test_category_isolation(
                                                                                                                    ...
                                                                                                                    def test_full_match_scores_1(
                                                                                                                        ...
                                                                                                                        def test_partial_match_scores_less_than_1(
                                                                                                                            self,
                                                                                                                        ):
                                                                                                                            pkg = _make_pkg(
                                                                                                                                "test",
                                                                                                                            ...
                                                                                                                            def test_results_sorted_descending(
                                                                                                                                ...
                                                                                                                                results = query_packages(
                                                                                                                                    "edtech integration market research",
                                                                                                                                    self.packages,
                                                                                                                                )
                                                                                                                                scores = [
                                                                                                                                    s
