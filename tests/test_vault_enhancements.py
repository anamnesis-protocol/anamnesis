...
"""
        ...
        enhanced, info = enhance_vault_file(
            file_path, sections, add_xrefs=True, update_metadata=True
        )
...
"""
        ...
        sections = ["Test"]
        enhanced, info = enhance_vault_file(file_path, sections, update_metadata=True)
...
def test_batch_enhance_vault():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        summary = batch_enhance_vault(
            vault_path, dry_run=False, add_xrefs=True, update_metadata=True
        )
...
def test_batch_enhance_vault_dry_run():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        summary = batch_enhance_vault(vault_path, dry_run=True, update_metadata=True)
