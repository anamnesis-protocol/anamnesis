                ...
                def test_dict_with_key_returns_user_key(self):
                    ...
                    def test_dict_without_provider_returns_none(self):
                        ...
                        result = _resolve_api_key(
                            "OPENAI_API_KEY", "openai", {"anthropic": "sk-ant-key"}
                        )
                        assert result is None
                            ...
                            def test_demo_mode_no_env_keys_returns_empty(self, monkeypatch):
                                ...
                                def test_demo_mode_with_openai_key(self, monkeypatch):
                                    ...
                                    def test_byok_empty_dict_returns_no_models(self):
                                        ...
                                        def test_byok_anthropic_key_returns_anthropic_only(
                                            self, monkeypatch
                                        ):
                                            ...
                                            for key in [
                                                ...
                                                result = available_models(
                                                    user_api_keys={"anthropic": "sk-ant-test"}
                                                )
                                                assert len(result) > 0
                                                providers = {m["provider"] for m in result}
                                            ...
                                            def test_byok_multiple_providers(self):
                                                ...
                                                def test_result_has_required_fields(
                                                    ...
                                                    class TestRecommendModel:
                                                        ...
                                                        ALL_KEYS = {
                                                            m_meta["provider"]: "test-key"
                                                            for m_meta in MODELS.values()
                                                        }

                                                        def test_general_query_returns_current_model_as_optimal(
                                                            self,
                                                        ):
                                                            """Unclassified message → current model is optimal, no switch."""
                                                            result = recommend_model(
                                                                "hello", "gpt-4o", self.ALL_KEYS
                                                            )
                                                            assert result["task_type"] == "general"
                                                            assert (
                                                                result["current_is_optimal"] is True
                                                            )
                                                            assert (
                                                                result["cannot_complete"] is False
                                                            )
                                                            ...
                                                            def test_coding_query_detected(self):
                                                                ...
                                                                def test_vision_query_detected(
                                                                    self,
                                                                ):
                                                                    ...
                                                                    assert (
                                                                        result["hard_requirement"]
                                                                        is True
                                                                    )

                                                                    def test_vision_no_capable_model_cannot_complete(
                                                                        self,
                                                                    ):
                                                                        ...
                                                                        assert (
                                                                            len(result["sidenotes"])
                                                                            > 0
                                                                        )

                                                                        def test_privacy_query_routes_to_ollama(
                                                                            self,
                                                                        ):
                                                                            ...
                                                                            def test_sidenotes_surface_unconfigured_preferred_models(
                                                                                self,
                                                                            ):
                                                                                ...
                                                                                def test_current_model_optimal_no_sidenotes(
                                                                                    self,
                                                                                ):
                                                                                    ...
                                                                                    def test_reasoning_query_detected(
                                                                                        ...
                                                                                        def test_fast_query_detected(
                                                                                            ...
                                                                                            def test_empty_keys_returns_sidenotes_not_errors(
                                                                                                self,
                                                                                            ):
                                                                                                ...
                                                                                                def test_response_has_all_required_fields(
                                                                                                    ...
                                                                                                    def test_unknown_current_model_does_not_crash(
                                                                                                        self,
                                                                                                    ):
                                                                                                            ...
                                                                                                            def test_all_profiles_have_required_keys(
                                                                                                                ...
                                                                                                                for (
                                                                                                                    ...
                                                                                                                    assert (
                                                                                                                        "preferred_models"
                                                                                                                        in profile
                                                                                                                    ), f"{name} missing preferred_models"
                                                                                                                    assert (
                                                                                                                        "hard_requirement"
                                                                                                                        in profile
                                                                                                                    ), f"{name} missing hard_requirement"

                                                                                                                def test_preferred_models_exist_in_registry(
                                                                                                                    self,
                                                                                                                ):
                                                                                                                    ...
                                                                                                                    for (
                                                                                                                        ...
                                                                                                                        for model_id in profile[
                                                                                                                            "preferred_models"
                                                                                                                        ]:
                                                                                                                            assert (
                                                                                                                                model_id
                                                                                                                                in MODELS
                                                                                                                            ), f"{name} references unknown model: {model_id}"

                                                                                                                    def test_vision_has_hard_requirement(
                                                                                                                        self,
                                                                                                                    ):
                                                                                                                        ...
                                                                                                                        def test_privacy_profile_prefers_ollama(
                                                                                                                            ...
                                                                                                                            assert first.startswith(
                                                                                                                                "ollama/"
                                                                                                                            ), f"Expected Ollama first, got {first}"
