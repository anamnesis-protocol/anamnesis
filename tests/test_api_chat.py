...
context_sections={"session_state": "state", "soul": "soul", "user": "user", "symbiote": "cfg"},
model_id="gpt-4o",
token_id="0.0.1234",
)
soul_pos = prompt.index("=== COMPANION IDENTITY ===")
user_pos = prompt.index("=== USER PROFILE ===")
cfg_pos = prompt.index("=== COMPANION CONFIGURATION ===")
...
assert "=== COMPANION IDENTITY ===" not in prompt
