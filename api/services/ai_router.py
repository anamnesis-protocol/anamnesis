...
def recommend_model(
 ...
 task_label — human-readable description ("Code generation / debugging")
 recommended_model_id — best configured model ID for this task (None if cannot_complete)
 ...
 # No preferred model configured at all — suggest the top 2 unconfigured
 sidenotes = [
 {
 "model_id": mid,
 "display": MODELS[mid]["display"],
...
async def _stream_ollama(
 ...
 # Strip the "ollama/" namespace prefix — Ollama uses bare model names
