...
Pricing:
 $4.10/month recurring — full access, no setup fee

Payment path:
 Stripe hosted Checkout Session (mode=subscription):
 $4.10/month recurring
...
Environment variables required:
 ...
 STRIPE_MONTHLY_PRICE_ID — Price ID for the $4.10/month recurring product
...
def create_checkout(request: Request, user_id: str = Depends(get_current_user)):
    ...
    Charges $4.10/month recurring. No setup fee.
    ...
    session = stripe.checkout.Session.create(
        ...
        mode="subscription",
        line_items=[
            {"price": monthly_price_id, "quantity": 1},  # $4.10/month
        ],
        ...
        if stripe_sub_id:
            ...
            try:
                ...
                if (
                    ...
                    and row.get("stripe_subscription_id") == stripe_sub_id
                ):
