    ...
    def get_keywords(self) -> Set[str]:
        ...
        keywords_map = {
            BoundedContext.AI_ENGINEERING: {
                "ai", "llm", "rag", "mcp", "agentic", "prompt", "genai",
                "embedding", "vector", "semantic", "claude", "gpt", "gemini",
                "langchain", "llamaindex", "agent", "reasoning"
            },
            BoundedContext.ARCHITECTURE: {
                "architecture", "ddd", "microservices", "design", "pattern",
                "solid", "clean", "hexagonal", "event", "driven", "cqrs",
                "saga", "domain", "bounded", "context"
            },
            BoundedContext.PYTHON: {
                "python", "oop", "class", "function", "async", "await",
                "decorator", "generator", "pytest", "unittest", "typing",
                "dataclass", "pydantic", "fastapi", "django", "flask"
            },
            BoundedContext.HEDERA: {
                "hedera", "hashgraph", "hts", "hfs", "hcs", "hbar",
                "consensus", "token", "nft", "smart", "contract", "solidity",
                "testnet", "mainnet", "account", "transaction"
            },
            BoundedContext.WEB3: {
                "blockchain", "web3", "ethereum", "defi", "nft", "wallet",
                "metamask", "crypto", "cryptocurrency", "decentralized",
                "dapp", "smart", "contract", "token", "evm"
            },
            BoundedContext.FRONTEND: {
                "react", "vue", "angular", "javascript", "typescript",
                "html", "css", "tailwind", "ui", "ux", "component",
                "frontend", "browser", "dom", "responsive"
            },
            BoundedContext.BACKEND: {
                "api", "rest", "graphql", "database", "sql", "postgres",
                "mongodb", "redis", "authentication", "authorization",
                "jwt", "oauth", "backend", "server", "endpoint"
            },
            BoundedContext.DEVOPS: {
                "docker", "kubernetes", "cicd", "github", "actions",
                "deployment", "monitoring", "logging", "prometheus",
                "grafana", "terraform", "ansible", "devops", "infrastructure"
            },
            BoundedContext.SECURITY: {
                "security", "encryption", "cryptography", "aes", "rsa",
                "hash", "signature", "authentication", "authorization",
                "owasp", "vulnerability", "audit", "penetration", "testing"
            },
...
def filter_packages_by_context(
    ...
    for pkg in packages:
        ...
        if not mapping:
            ...
            inferred = infer_contexts_from_keywords(
                pkg.name,
                pkg.keywords,
                pkg.description
            )
...
def get_context_summary(context_mappings: dict[str, ContextMapping]) -> dict:
    ...
    return {
        ...
        "context_distribution": {
            ...
            for ctx, count in sorted_contexts if count > 0
        },
    }
